# Source: `Product-Statistics-UPI-Upi-downtime-April-2026-downtime.xlsx`
...
**Figures present:** per-bank incident counts and downtime durations for April 2026.
...
- Total incidents: 19
- Total downtime: 50.8 hours across all banks
- Downtime as share of the month, per affected bank:
  mean 0.64%, min 0.12%, max 2.44%
