# Source: `Product-Statistics-UPI-Upi-downtime-June-2026-downtime.xlsx`
...
One sheet, `Product Statistics`, 13 data rows.
...
**Figures present:** per-bank incident counts and downtime durations for June 2026.
Nothing else. No transaction counts, no failure reasons, no success rates.

## Mechanical summary

- Banks reporting downtime: 13
- Total incidents: 25
- Total downtime: 73.1 hours across all banks
- Downtime as share of the month, per affected bank:
  mean 0.78%, min 0.09%, max 2.52%

Month length used: 30 days (720 hours).
